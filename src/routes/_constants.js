const strings = {
  website: "https://fi.pattern.monster",
  title: "Pattern Monster",
  description:
    "Yksinkertainen verkkopohjainen kuviongeneraattori toistuvien SVG-kuvioitten luomiseen.",
  description2: "Nopeuta verkkosivustoasi tinkimättä kuvan laadusta.",
  description3: 
    "Täydellinen verkkosivujen taustoihin, vaatteisiin, brändäykseen, pakkaussuunnitteluun ja paljon muuhun.",
  keywords:
    "svg-kuvioita, kuvioita, svg-taustoja, vektoritaustakuvia, kuvio generaattori, kuvio luoja",
  pages: [
    {
      page: "index",
      title: "SVG-kuvioiden generaattori",
      keywords: "",
      description: "",
      image: "",
    },
